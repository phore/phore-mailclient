...
use Phore\MailClient\Automation\{Folder, MailAutomation, MailActions, MailContext, RunReport};
...
// onFolder(Folder::Sent) wählt neue Sent-Beobachtungen; addAutomation registriert die Automatisierung.
// automationId benennt sie, priority bestimmt die Reihenfolge. matches ist eine reine Bedingung.
...
$automation->onFolder(Folder::Sent)->addAutomation(
    automationId: 'sent.create-user', priority: 0,
...
// onFolder(Folder::Inbox) wählt die Inbox. user ist bereits aufgelöst (MailUser|null), samt Metadaten.
...
$automation->onFolder(Folder::Inbox)->addAutomation(
    automationId: 'inbox.classify', priority: 0,
...
// Überblick: Client+storage verbinden; onFolder(Folder::Sent)/onFolder(Folder::Inbox) wählen Auslöser;
