...
// onFolder(Folder::Inbox) wählt den Hauptordner. addAutomation registriert eine Regel mit optionaler automationId.
...
$automation->onFolder(Folder::Inbox)->addAutomation(
    automationId: 'incoming.review', priority: 300,
...
$automation->onFolder(Folder::Inbox)->addAutomation(
    automationId: 'incoming.b2b', priority: 200,
...
$automation->onFolder(Folder::Inbox)->addAutomation(
    automationId: 'incoming.unknown', priority: 100,
...
$automation->onFolder(Folder::Inbox)->addAutomation(
    automationId: 'incoming.other-known', priority: 0,
...
$automation->onFolder('B2B')->addAutomation(
    automationId: 'b2b.ready', priority: 0,
    matches: fn (Email $mail, MailContext $context): bool => true,
